...
export function SiteFooter() {
  return (
    <footer className="bg-[#141a2e]">
      <div className="h-[3px] bg-gradient-to-r from-violet-500 via-indigo-400 to-cyan-400" />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-3">
            ...
            <a href="#" className="inline-flex items-center gap-1 text-[13px] text-cyan-400 hover:text-cyan-300 transition-colors">访问官网 →</a>
          </div>
          <div className="space-y-3">
            ...
            <a href="#" className="inline-flex items-center gap-1 text-[13px] text-cyan-400 hover:text-cyan-300 transition-colors">进入资源商城 →</a>
          </div>
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-[13px] text-[#a8b3cf]">
              ...
              <li><a href="#" className="text-cyan-400 hover:text-cyan-300 transition-colors">使用手册</a></li>
              <li><a href="#" className="text-cyan-400 hover:text-cyan-300 transition-colors">常见问题</a></li>
            </ul>
          </div>
          <div className="space-y-3">
